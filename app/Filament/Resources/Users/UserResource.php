...
class UserResource extends Resource
{
    ...
    // Specifica come si chiama la relazione nel modello Company (Tenant)
    // Questo dice a Filament: "Usa $company->users() per query e creazioni"
    protected static ?string $tenantRelationshipName = 'users';

    // 2. AGGIUNGI QUESTA RIGA:
    // Diciamo a Filament: "Nel modello User, la relazione verso le aziende si chiama 'companies'"
